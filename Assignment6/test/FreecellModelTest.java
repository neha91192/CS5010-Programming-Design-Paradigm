...
public class FreecellModelTest {
  ...
  private FreecellOperations<Card> game1;
  private FreecellOperations<Card> game2;
  private FreecellOperations<Card> game3;

  private List<String> deck;

  private String initialGameStateWithoutShuffle;

  private List<Card> deckToPlay1;
  private List<Card> deckToPlay2;
  ...
  @Before
  public void setup() {
    game1 = FreecellModel.getBuilder().cascades(4).opens(1).build();
    game2 = FreecellModel.getBuilder().cascades(5).opens(1).build();
  ...
  private List<Card> createValidDeckToPlay(String cards) {
  ...
  // get deck, shuffle non shuffle cases - need to check line 431
  // how to check getdeck - line 431
}
