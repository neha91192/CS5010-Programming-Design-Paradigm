...
/**
 * Checks for the priority of two cards. In this comparator, Ace is given lower priority than other
 * cards. If A has to be given higher priority for any other card game, a new comparator can be
 * implemented.
 */
public class CardComparator implements Comparator<Card> {
   ...
   * @return -1 if card1 is smaller than card2, 1 if card1 is smaller
   */
  @Override
