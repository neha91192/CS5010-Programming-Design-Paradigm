...
/**
 * This interface represents Iterator methods defined for generating look-and-say sequence using
 * Iterator pattern.
 ...
 * produces 112321.</p>
 * <p>This interface adds two additional methods: prev and hasPrevious which also helps in
 * traversing backwards. Other two methods are extended from the {@link Iterator} of type
 * BigInteger.</p>
 */
