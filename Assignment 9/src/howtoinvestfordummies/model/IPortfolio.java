...
public interface IPortfolio {
   ...
   * should return the sum of the latest value up to 2 digits specified for the date for the all the
   ...
   * . It therefore sums up all the investment cost values and returns the final values.</p>
   *
