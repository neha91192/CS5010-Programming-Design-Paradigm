...
/**
 * Class to configure an existing portfolio in the model to support High Level Investments.
 */
public class ConfigureInvestmentStrategies extends StockInvestmentCommandImpl {
  ...
  public void execute(StockInvestmentStrategies model) {
    ...
    view.transmitMessage("Press l to list portfolios");
    while (true) {
      ...
      view.transmitMessage("Enter name of the portfolio for which you want to "
  ...
  /**
   * Will ask user to enter the number of stocks he wants to group for recurring investment. If the
  ...
  /**
   * Will ask user if he wishes to add weights for each of the stock he has added in this group. If
  ...
  /**
   * Will ask user to enter the weights for each of the stock he has added in this group. If the
   * input is not a valid number, or If the weights do not add up to 100 will prompt user to enter
   * correct weights.
   *
  ...
  /**
   * Will ask user to enter the commissions for each of the stock he has added in this group. If the
  ...
  /**
   * Will ask user to enter the frequency interval (in DAYS) in which he wishes to invest on the
   * group of stocks for recurring investment. If the input is not a valid number, will prompt user
  ...
  /**
   * Provides option to select the investment strategy out of all available high-level strategies.
   *
   * @param model of type StockInvestmentStrategies Interface.
   */
