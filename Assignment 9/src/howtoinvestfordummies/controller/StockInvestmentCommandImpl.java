...
public abstract class StockInvestmentCommandImpl implements StockInvestmentCommand {
  ...
  protected String formatPortfolioNames(List<IPortfolio> portfolioList) {
    ...
    if (portfolioList.isEmpty()) {
      view.transmitMessage("You do not have any portfolios created yet. Please create by going "
  ...
  /**
   * Will ask user to enter the amount he wishes to invest on stock. If the input is not a valid
  ...
  /**
   * Will ask user to enter Yes or No if he wishes to add add new value for the stock. If the input
