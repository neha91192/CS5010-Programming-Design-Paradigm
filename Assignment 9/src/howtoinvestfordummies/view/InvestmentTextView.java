...
/**
 * Represents a class with Text based view implementation. The main objective of this class is to
...
public class InvestmentTextView implements IInvestmentView {
  ...
  /**
   * Constructor of this class. Takes input as {@link Readable} and returns output as {@link
   * Appendable} object.
   *
