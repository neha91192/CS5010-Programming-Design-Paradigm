...
/**
 * Tests for {@link InvestmentController}. It checks if the Controller class is working
 * fine in
 * isolation with the Mock Model.
 * <p>This test class checks for the correctness of Controller. It checks for each
 * methods that is being called through the controller to a model called "MockModel"
 * See {@link
 ...
 * model that is
 * the implementation of {@link InvestmentStrategies} and transmitting the log
...
public class InvestmentControllerIsolationTest {
  ...
  /**
   * Invalid date to mock model in buy shares. The message returned by mock model will
   * be asserted
   * here.
   */
  @Test
