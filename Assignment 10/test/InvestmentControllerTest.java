...
public class InvestmentControllerTest {
  ...
  @Before
  public void setUp() {
    model = new StockInvestmentStrategiesModel();
    view = new InvestmentTextView(in, out);
  }
  ...
  public void testReadableInvalid() {
    ...
    controller = new InvestmentController(view, model);
  }
  ...
  public void testNullModel() {
    ...
    IInvestmentController controller = new InvestmentController(view, null);
    try {
      controller.start();
      fail("Error");
