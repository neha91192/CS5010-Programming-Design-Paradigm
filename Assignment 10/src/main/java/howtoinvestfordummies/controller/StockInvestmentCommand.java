...
/**
 * This interface represents common command interface for performing stock investment
 * related
...
public interface StockInvestmentCommand {
  /**
   * Represents the common method referred by the command classes to perform their
   * operations.
   *
   * @param model of type StockInvestmentStrategies.
   */
  void execute(StockInvestmentStrategies model);
}
