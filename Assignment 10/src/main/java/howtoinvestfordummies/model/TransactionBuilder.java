 ...
 * Transaction} instances. Depending upon default configuration of the implementation
 * classes of
 * TransactionBuilder Interface, the Transaction will be initialized with appropriate
 * values.
 */
public interface TransactionBuilder {
  ...
  /**
   * Build method finally returns the instance of required class. Depending upon what
   * values were
