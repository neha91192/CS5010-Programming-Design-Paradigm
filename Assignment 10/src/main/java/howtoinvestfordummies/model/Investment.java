...
/**
 * Represents a common class for providing implementations specific to all types of
 * investments.
 */
public abstract class Investment implements IInvestment {
  ...
  /**
   * Constructor to initialize Investment object. It takes cost and date of purchase as
   * parameters.
   *
  ...
  /**
   * This method is abstracted in order to let the child implementation decide the
   * current value of
   * investment. Every type of investment will have a particular logic to calculate and
   * depending
   * upon the current value of each investment unit, it will be derived by each
   * investment type and
   * not at the abstract level. The subclasses may choose to avoid the implementation
   * by making this
  ...
  /**
   * Returns cost of the investment. While initiating the investment object, this cost
   * is stored and
