...
/**
 * Represents class to handle business logic of this application. Information such as
 * operating
...
class TradingInformation implements ITradingInformation {
  ...
  /**
   * Checks if the user date is acceptable for trading. It first creates closing date
   * object and
   * opening date object and compares if the current date is withing the range. It also
   * checks if
