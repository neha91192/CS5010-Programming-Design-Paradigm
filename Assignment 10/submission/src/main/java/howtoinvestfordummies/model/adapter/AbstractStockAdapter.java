...
/**
 * Abstract adapter to perform common implementation for all the adapters implementing
 * {@link
...
public abstract class AbstractStockAdapter implements IStockAdapter {
  /**
   * Parses Date object and converts it into required String format. This method
   * converts Date in
   ...
   */
  @Override
  public abstract double getStockPriceForBuying(String symbol, Date date) throws
          Exception;
