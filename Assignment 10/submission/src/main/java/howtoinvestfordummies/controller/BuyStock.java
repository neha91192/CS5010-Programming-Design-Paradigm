...
import howtoinvestfordummies.model.PortfolioType;
...
public class BuyStock extends StockInvestmentCommandImpl {
  ...
  /**
   * This method takes the required model to find output data required to transmit back
   * to user. If
   * the input is l, it will list all the existing portfolio names. If the input is c,
   * it will
  ...
  /**
   * Represents controller logic for buying shares. It interacts with model  to return
   * appropriate
