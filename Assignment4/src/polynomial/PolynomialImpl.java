...
public class PolynomialImpl implements Polynomial, Comparable {
  ...
  /**
   * Takes term as string and converts into {@link Term}. Uses Delimiter "x\\^" to parse coefficient
   * and power in the term String.
   *
   * @param term representing String form of the term.
   * @return term of type Term.
   * @throws IllegalArgumentException or InputMismatchException in case of invalid term String.
   *
   */
