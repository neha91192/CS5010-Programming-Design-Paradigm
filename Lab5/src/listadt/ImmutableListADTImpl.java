 ...
 * {@link ListADT} and implements all its required operations in immutable fashion.</p>
 */
public class ImmutableListADTImpl<T> implements ListADT<T> {
  ...
  /**
   * Returns the immutable list version of itself with the same head node. Since the
   * ImmutableListADT implementation preserves immutability, the original head would not be affected
   * if any changes happens in the return instance.
   *
   * @return immutable instance of this class.
   */
  @Override
