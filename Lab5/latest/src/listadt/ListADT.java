 ...
 *
 * We represent the type of data that this will work with a generic parameter T. This is a
...
public interface ListADT<T> {
  ...
  /**
   * Returns an instance of Immutable version of itself. This list would be a read-only list
   * containing the same value as itself.
   *
