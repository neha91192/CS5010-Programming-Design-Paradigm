...
public final class ExceptionMessageConstants {
  ...
  /**
   * Error message indicating if the first operand is negative.
   */
  public static final String NEGATIVE_NUMBER_NOT_ALLOWED = "You have given negative input."
          + " Please give a valid operand.";
}
