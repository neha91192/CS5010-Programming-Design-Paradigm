...
public class RemoteStockAdapterImpl extends AbstractStockAdapter {
  ...
  /**
   * URL for fetching data of a company in csv format.
   */
  private String DAILY_URL = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY"
  ...
  private String getDataFromAPI(String stockSymbol) throws Exception {
    ...
    try {
      url = new URL(DAILY_URL.replace("STOCK_SYMBOL", stockSymbol));
