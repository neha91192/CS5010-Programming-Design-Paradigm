...
public class DetermineCostAndValue extends StockInvestmentCommandImpl {
  ...
  public void go(StockInvestmentStrategies model) {
    transmitMessage("Enter 'l' to list existing portfolio for which you want to find cost and value "
            + "or 'c' to continue if you know portfolio name or # to execute back");
    while (true) {
