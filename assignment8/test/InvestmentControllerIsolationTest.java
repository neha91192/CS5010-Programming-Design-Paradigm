 ...
 * is being called through the controller to a model called "MockModel" See {@link MockModel} for
 * more details.</p>
...
public class InvestmentControllerIsolationTest {
  /**
   * AppState is set to started, when app is already started. Model should set the same string.
   */
