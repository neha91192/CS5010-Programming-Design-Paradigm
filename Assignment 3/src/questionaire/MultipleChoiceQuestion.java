...
public class MultipleChoiceQuestion extends MultipleAnswersQuestion {
   ...
   * equal if they are of same instance, their Question Text and options are exactly the same and
   ...
   * {@link MultipleChoiceQuestion#equalsMultipleChoiceQuestion(MultipleChoiceQuestion)} and then
  ...
  public boolean equals(Object object) {
    ...
    if (question.equalsMultipleAnswerQuestion(this)) {
      ...
      return multipleChoice.getQuestionText().equals(this.getQuestionText())
              && Arrays.equals(this.options, multipleChoice.options);
    }
    return false;
  }

  /**
   * Overriding hashcode implementation. Considering Question Text to evaluate hashcode in this
   * implementation. Any new attributes added while considering equality for multiple choice
   * question can be added to this <tt>hashCode</tt> implementation.
   *
