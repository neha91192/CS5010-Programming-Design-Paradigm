...
/**
 * <p>
 * The purpose of designing this interface is to support availability of the question text to the
 * user so that it can be answered and evaluated through some means.
 * </p>
 * <p>This interface exposes two main methods</p>
 * <ul>
 * <li><strong>getQuestionText</strong></li>
 * <li><strong>evaluate</strong></li>
 * </ul>
 * <p>Implementation can focus on returning Question text and evaluate answer of the question
