...
import questionaire.QuestionBankComparator;
...
//            " 1 2  3 4  ", options);
  ...
  public void testAttemptLikertCorrect() {
    String userAnswer = "2";
    String result = likertQuestion.evaluate(userAnswer);
    assertEquals(EvaluationResult.CORRECT.name(), result);
  }
   ...
   */
  @Test
  public void testAttemptMultipleChoiceCorrect() {
    String userAnswer = "2";
    String result = multipleChoiceQuestion.evaluate(userAnswer);
    assertEquals(EvaluationResult.CORRECT.name(), result);
   ...
   */
  @Test
  public void testAttemptMultipleChoiceIncorrect() {
  ...
  public void testSetMultipleAnswerUserAnswer() {
    multipleAnswerQuestion.evaluate("1 2");
  }
  ...
  public void testSetMultipleChoiceUserAnswer() {
    multipleChoiceQuestion.evaluate("1");
  }
  ...
  public void testQuestionBankOrdering() {
    ...
    Arrays.sort(questionaire,new QuestionBankComparator());
    assertEquals(YesNoQuestion.class, questionaire[0].getClass());
    assertEquals("Are you in Final Year?", questionaire[0].getQuestionText());
    assertEquals(YesNoQuestion.class, questionaire[1].getClass());
    assertEquals("Is Sky Blue?", questionaire[1].getQuestionText());
    assertEquals(LikertQuestion.class, questionaire[2].getClass());
