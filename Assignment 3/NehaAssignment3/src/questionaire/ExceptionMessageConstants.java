...
public final class ExceptionMessageConstants {
   ...
   */
  public static final String INVALID_CORRECT_ANSWER_YESNO = "Not a valid correctAnswer format "
          +"for Yes or No type questions";
  /**
   * Error message indicating invalid correct correctAnswer input for Yes or No type questions.
   */
  public static final String INVALID_CORRECT_ANSWER_LIKERT = "Not a valid correctAnswer format "
